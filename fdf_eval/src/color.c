...
/*   Updated: 2023/04/28 12:27:24 by lilizarr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fdf.h"

static void	h_rgb(float v1, float v2, float v3, t_color *c)
{
	c->h = v1;
	c->s = v2;
	c->l = v3;
